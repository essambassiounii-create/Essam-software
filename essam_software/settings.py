...
SECRET_KEY = 'django-insecure-essam-software-dev-key-change-in-production-2024'
...
ROOT_URLCONF = 'essam_software.urls'
...
WSGI_APPLICATION = 'essam_software.wsgi.application'
